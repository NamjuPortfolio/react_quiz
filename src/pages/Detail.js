          ...
          <div className="basis-full text-center">
            {
              ...
              : 
              <div>
                <p className='text-lg'>총 <span className="font-bold text-indigo-500 text-xl"></span>문제 중 <span className="font-bold text-indigo-500 text-xl">{_score}</span>문제를 맞추셨으며, 점수는 <span className="text-indigo-500 font-bold text-xl">{Math.floor((_score / quizList.length)*100)}</span>점 입니다.</p>
              </div>
            }
          </div>
        </div>
